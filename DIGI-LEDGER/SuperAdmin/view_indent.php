  ...
  <body>
    ...
    <div class="container">
      <?php
        ...
        $sql = "SELECT i.indent_id, i.indent_subject, i.indent_link, i.indent_status,i.indent_timestamp, s.s_name FROM `indent` as i , school as s WHERE i.school_id=s.s_id";
                          ...
                          echo "<div class='card-body'>";
                            ...
                            echo "<div class='row'>";
                              ...
                              echo "<div class='col-1 '>";
                                echo "<a href='app_indent.html'><img src='https://img.icons8.com/emoji/36/000000/check-mark-emoji.png'/></a>";
                              echo "</div>";
                              echo "<div class='col-1 '>";
                                echo "<a href='rej_indent.html'><img src='https://img.icons8.com/emoji/36/000000/cross-mark-emoji.png'/></a>";
                              echo "</div>";
                            echo "</div>";
                          echo "</div>";
                        echo "</div>";
