  ...
  <body>
    ...
    <div class="container">
      <?php
        ...
        // $sql2 = "SELECT * FROM digi.student";
        $sql = "SELECT s.stu_id, s.stu_fname, s.stu_lname, s.stu_dob, s.stu_age, s.Sex, s.stu_std, s.stu_father, s.stu_mother, sc.s_name FROM student AS s, school AS sc WHERE s.s_id=sc.s_id";
        // $sql2= "SELECT s.stu_id, s.stu_fname, s.stu_lname, s.stu_dob,s.stu_age, s.stu_father, s.stu_mother, s.s_id, sc.s_id, sc.s_name FROM student AS s, school AS sc WHERE s.s_id=sc.s_id";
